...
using CustomerFeedbackUsingMLDemoML.Model;

namespace CustomerFeedbackUsingMLDemoML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"L:\My Projects\AIML\sentiment labelled sentences\sentiment labelled sentences\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"C:\Users\Hammad\AppData\Local\Temp\MLVSTools\CustomerFeedbackUsingMLDemoML\CustomerFeedbackUsingMLDemoML.Model\MLModel.zip";
